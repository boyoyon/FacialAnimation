...
・駆動用画像群を driving_images フォルダに配置する

python tsp_animation_from_images.py (画像ファイル)

"""

import cv2, glob, os, sys, yaml
import numpy as np
import torch
from demo import relative_kp, load_checkpoints, make_animation, find_best_frame

wildcard_for_images  = './driving_images/*.png'
img_shape   = (256,256)
...
def main():
    ...
    paths = glob.glob(wildcard_for_images)
